...
export function VoicePreviewPlaceholder() {
  return (
    <div className="hidden shrink-0 flex-col items-center justify-center gap-6 border-t py-10 lg:flex lg:min-h-48">
      <div className="flex flex-col items-center gap-3 ">
        ...
        <p className="mx-w-64 text-center text-sm text-muted-foreground">Once you generate your audio will appear here, Sit back and relax.</p>
      </div>
