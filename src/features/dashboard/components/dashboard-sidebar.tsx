...
export function DashboardSidebar() {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    { title: "Help and support", url: "mailto:iamprashant220502@gmail.com", icon: Headphones },
  ];
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
          <Image src="/resonance-favicon.svg" alt="resonance" width={24} height={24} className="rounded-sm" />
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <OrganizationSwitcher hidePersonal
              ...
              appearance={{
                elements: {
                  rootBox: "w-full! group-data-[collapsible=icon]:flex! group-data-[collapsible=icon]:justify-center!",
                  ...
                  organizationPreviewTextContainer: "text-sm! tracking-tighter! font-medium! text-foreground! group-data-[collapsible=icon]:hidden!",
                  organizationPreviewMainIdentifier: "text-[13px]!",
                  organizationSwitcherTriggerIcon: "size-4! group-data-[collapsible=icon]:hidden! text-sidebar-foreground!"
                },
              }}
            />
          </SidebarMenuItem>
      ...
      <SidebarFooter className="gap-3 py-3">
        <SidebarMenu>
          <SidebarMenuItem>
            <UserButton showName fallback={<Skeleton className="h-8.5 w-full group-data-[collapsible=icon]:size-8 rounded-md border border-border bg-white" />}
              appearance={{
                elements: {
